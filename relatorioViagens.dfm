object fmRelatorioViagens: TfmRelatorioViagens
  ...
  object frRelatorioViagemAnalitico: TfrxReport
    Version = '4.9'
    ...
    ReportOptions.LastChange = 42179.622266354170000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Date: TfrxMemoView
          Left = 624.575140000000000000
          Top = 3.984230000000000000
          Width = 64.252010000000000000
          Height = 18.897650000000000000
          ShowHint = False
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Relat'#243'rio de Despesa com ve'#237'culos'
            '(R$: 0,25 / km utlizado) ')
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object quAgendaDetail: TSQLQuery
    ...
    SQL.Strings = (
      'select '
        ...
        '   id_veiculo, nome_veiculo, dataagendaini, dataagendafim, sum(k' +
        'msaldo) as km_usado, sum(custototalkm) as custo_total, id_docent' +
        'e, kmsaida, kmretorno'
      'from '
      '   agenda'
      'group by '
  ...
  object frRelatorioViagemSintetico: TfrxReport
    Version = '4.9'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 41988.592348159700000000
    ReportOptions.LastChange = 42179.622266354200000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object DetailData1: TfrxDetailData
        ...
        DataSetName = 'frAgendaDetail'
        RowCount = 0
        object frAgendaDetailID_DOCENTE: TfrxMemoView
